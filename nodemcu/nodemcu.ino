...
//---------firebase---------
#define FIREBASE_HOST "***" adicione o seu endereco firebase
#define FIREBASE_AUTH "***" //Adicione a sua chave do firebase
//------------ configuracao DHT11 --------------
#define DHTPIN D4
...
char* SSID = "**"; //adicione a sua rede wifi
char* PASSWORD =  "**"; //adicione a sua senha da rede
